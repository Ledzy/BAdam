...
class FinetuningArguments:
    ...
    wandb_run_id: Optional[str] = field(
        default=None,
        metadata={"help": "The ID of the W&B run to resume from."}
    )
    ...
    badam_verbose: Optional[int] = field(
        default=1,
        metadata={"help": "The verbosity level of the block-wise optimizer."}
    )
    debug_mode: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to run the fine-tuning in debug mode."}
    )
    ...
    finetuning_type: Optional[Literal["lora", "freeze", "full", "none", "block", "sparse"]] = field(
        default="lora",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "freeze", "full", "none", "block", "sparse"], "Invalid fine-tuning method."
